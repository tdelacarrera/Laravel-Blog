<x-layouts::app>
    ...
    <div class="mt-6">
        <div class="flex justify-between items-center mb-4">
            <h1 class="text-xl font-semibold text-heading dark:text-white">Tags</h1>
            <a href="{{ route('admin.tags.create') }}" class="px-4 py-2 bg-blue-500 text-white  dark:bg-blue-500  rounded-md shadow  hover:bg-blue-700  dark:hover:bg-blue-400 transition">
                Add Tag
            </a>
        </div>
                    ...
                    @foreach($tags as $tag)
                        <tr class="bg-white dark:bg-neutral-900 border-b border-default dark:border-neutral-700 hover:bg-neutral-primary-soft dark:hover:bg-neutral-800 transition">
                            ...
                            <td class="px-6 py-4 flex justify-center gap-2">
                                <a href="{{ route('admin.tags.edit', $tag) }}" class="px-3 py-1 bg-blue-500 text-white rounded hover:bg-blue-600 transition">
                                    Edit
                                </a>
